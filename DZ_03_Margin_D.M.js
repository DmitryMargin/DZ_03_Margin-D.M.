/* # DZ_03_Margin-D.M. "—оздание базы пользователей и манипул€ции базой"
...
/* ‘ункци€ дл€ создани€ новых пользователей: */
...
/* ‘ункци€ дл€ контрол€ мин.длины имени и фамилии нового пользовател€: */
...
/* ‘ункци€, в которую помещены существующие пользователи и добавл€ютс€ новые (тут € немного сомневалс€, 
необходимо ли существующих внутрь функции помещать или только новых, а существующих вынести за рамки функции? 
в конце файла есть вариант с объ€влением users внутри функции): */
...
/* —оздаем новый массив, перебираем users и делаем все имена и фамилии с заглавной буквы: */
...
/* »щем пользователей, у которых им€ или фамили€ начинаютс€ на букву "≈": */
...
/* ## Task 4
 *//* »щем пользователей старше 30 лет и фильтруем их по возрасту: */
...
/* ## Task 1_вариант с объ€влением users вместе с существующими пользовател€ми внутри функции */
